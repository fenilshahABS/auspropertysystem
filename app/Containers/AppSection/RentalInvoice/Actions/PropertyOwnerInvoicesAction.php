...
use App\Containers\AppSection\RentalInvoice\Tasks\PropertyOwnerInvoicesTask;
use App\Containers\AppSection\RentalInvoice\UI\API\Requests\GetAllRentalInvoicesRequest;
use App\Ship\Parents\Actions\Action as ParentAction;
use Prettus\Repository\Exceptions\RepositoryException;

class PropertyOwnerInvoicesAction extends ParentAction
{

    public function run(GetAllRentalInvoicesRequest $request, $InputData)
    {
        return app(PropertyOwnerInvoicesTask::class)->run($InputData);
    }
}
