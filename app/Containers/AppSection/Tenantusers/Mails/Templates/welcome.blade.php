    ...
    <tbody>
      ...
      <tr style="width: 100%;">
        <td style="background-color: #0c3779; border-bottom: 3px solid #0c3779; border-left: 2px solid #0c3779; border-right: 2px solid #0c3779;" align="left" valign="top" bgcolor="#222">
          <table style="width: 100%; height: 90px;" border="0" width="100%" cellspacing="0" cellpadding="15">
            <tbody>
              <tr style="width: 100%;">
                <td style="font-family: Arial, Helvetica, sans-serif; text-align: center; font-size: 14px; padding: 10px; width: 50%; color: #ffffff; border-bottom: 1px solid #ffffff; border-right: 1px solid #ffffff; font-weight: bold;" align="left" valign="top">Whatsapp Us</td>
                <td style="font-family: Arial, Helvetica, sans-serif; text-align: center; font-size: 14px; padding: 10px; width: 50%; color: #ffffff; border-bottom: 1px solid #ffffff; font-weight: bold; border-right: 1px solid #ffffff;">Visit Us</td>
              </tr>
              <tr style="width: 100%;">
                <td style="color: #ffffff; font-family: Arial, Helvetica, sans-serif; text-align: center; text-decoration: none; border-right: 1px solid #ffffff; font-size: 14px; padding: 0px 0px 10px; width: 50%;" align="left" valign="top"><br /> <a style="color: #ffffff; text-decoration: none;" href="tel:<?php echo $data['mobile']; ?> "><strong style="color: #ffffff; text-decoration: none;"><?php echo $data['mobile']; ?></strong></a></td>
                <td style="color: #ffffff; font-family: Arial, Helvetica, sans-serif; text-align: center; padding: 0px 0px 10px; font-size: 14px; width: 50%; border-right: 1px solid #ffffff;"><a style="color: #ffffff; text-decoration: none;" href="mailto:<?php echo $data['tenant_link']; ?>"> <br /><strong style="color: #ffffff; text-decoration: none;"><?php echo $data['tenant_link']; ?></strong></a></td>
              </tr>
            </tbody>
          </table>
        </td>
