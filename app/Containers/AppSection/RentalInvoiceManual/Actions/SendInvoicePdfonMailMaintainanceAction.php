...
use App\Containers\AppSection\RentalInvoiceManual\Tasks\SendInvoicePdfonMailMaintainanceTask;
use App\Containers\AppSection\RentalInvoiceManual\UI\API\Requests\CreateRentalInvoiceManualRequest;
use App\Ship\Exceptions\CreateResourceFailedException;
use App\Ship\Parents\Actions\Action as ParentAction;

class SendInvoicePdfonMailMaintainanceAction extends ParentAction
{
    use HashIdTrait;
    ...
    public function run(CreateRentalInvoiceManualRequest $request, $InputData)
    {
        ...
        return app(SendInvoicePdfonMailMaintainanceTask::class)->run($path, $InputData);
    }
}
