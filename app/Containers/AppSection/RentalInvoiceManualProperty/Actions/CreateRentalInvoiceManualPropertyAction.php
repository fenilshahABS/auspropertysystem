...
use App\Containers\AppSection\RentalInvoiceManualProperty\Tasks\CreateRentalInvoiceManualPropertyTask;
...
class CreateRentalInvoiceManualPropertyAction extends ParentAction
{
    use HashIdTrait;
    ...
    public function run(CreateRentalInvoiceManualPropertyRequest $request, $InputData)
    {
        ...
        return app(CreateRentalInvoiceManualPropertyTask::class)->run($data, $rent_invoice_details);
    }
}
