...
use App\Containers\AppSection\Propertymaster\Tasks\GetOwnerWiseAllPropertymastersTask;
use App\Containers\AppSection\Propertymaster\UI\API\Requests\GetAllPropertymastersRequest;
use App\Ship\Parents\Actions\Action as ParentAction;
use Prettus\Repository\Exceptions\RepositoryException;

class GetOwnerWiseAllPropertymastersAction extends ParentAction
{
    /**
    ...
    {
            return app(GetOwnerWiseAllPropertymastersTask::class)->run($InputData);
    }
}
